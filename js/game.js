...
const loop=new FixedStepLoop({update,render:()=>{renderer.draw(app.state==='battle'?fighters:[],effects);if(app.state==='battle')hud.update(fighters,match,app.t);},logicHz:WORLD.logicHz});
